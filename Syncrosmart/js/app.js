...
document.addEventListener("DOMContentLoaded", llamarAPI); // Agrega un evento que llama a la función 'llamarAPI' 
...
// ------------------------------funciones para el filtro y el buscador---------------------------------------------
document.getElementById('searchForm').addEventListener('submit', function(event) {//adjunta un escuchador de eventos.
